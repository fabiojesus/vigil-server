...
function resolvers(){
    return{
        ...
        examiners:  (args) => {return Queries.examinees(args.token)},
        examiner:   (args) => {return Queries.examinee(args.token, args.id)},
        examinees:  (args) => {return Queries.examiners(args.token)},
        examinee:   (args) => {return Queries.examiner(args.token, args.id)},
        ...
        registerTest: (args) => {return Mutations.registerTest(args.dateStart, args.dateEnd, args.dateLimit, args.subjectId, args.type)},
        registerExaminee: (args) => {return Mutations.registerExaminee(args.name, args.identification, args.email)},
        registerExaminer: (args) => {return Mutations.registerExaminer(args.name, args.identification, args.email)},
